...
var send_url = document.querySelector(".send-url");
var url_name = document.querySelector("input.url-name");
var short_url = document.querySelector("div.short-url");
var csrf_token = document.querySelector('meta[name="csrf-token"]').getAttribute("content");

if (send_url) {
  send_url.addEventListener("click", function (event) {
    fetch("/", {
      method: "POST",
      headers: {
      ...
      if (data.status !== 200) {
        ...
        short_url.querySelector("a").setAttribute("href", "http://" + data.short_url);
